...
import EliminarEmbarcacionClient from './EliminarEmbarcacionClient';
...
export default async function EliminarEmbarcacionPage({
    params,
}: {
    ...
    return <EliminarEmbarcacionClient embarcacion={embarcacion} />;
}
