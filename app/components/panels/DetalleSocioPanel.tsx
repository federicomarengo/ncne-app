...
interface DetalleSocioPanelProps {
  isOpen: boolean;
  onClose: () => void;
  socio: Socio | null;
  onEdit?: () => void;
...
export default function DetalleSocioPanel({
  isOpen,
  onClose,
  socio,
  onEdit,
  ...
  return (
    <SidePanel isOpen={isOpen} onClose={onClose} title="Detalle del Socio" size="xl">
